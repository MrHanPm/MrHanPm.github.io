...
$(document).ready(function(){
	...
	//	alert(num.substr(1));
	turnplate.restaraunts = ["2元", "5元", "10元", "15元", "20元", "30元","50元", "再接再厉"];
	turnplate.colors = ["#fff4bd", "#fff", "#fff4bd", "#fff", "#fff4bd", "#fff", "#fff4bd", "#fff"];
	  ...
	  for(var i = 0; i < turnplate.restaraunts.length; i++) {       
		  ...
		  if(text.indexOf("\n")>0){//换行
			  ...
			  for(var j = 0; j<texts.length; j++){
				  ctx.font = j == 0?'24px Microsoft YaHei':'24px Microsoft YaHei';
